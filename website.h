void website(EthernetClient client, Switcher &sw1, Switcher &sw2, Switcher &sw3, const char* status1, const char* status2, const char* save, const char* version){
     ...
     client.print(F("\"&T6=\" + formData.get(\"S16\") +"));
     client.print(F("\"&T7=\" + formData.get(\"S17\") +"));
     client.print(F("\"&T8=\" + formData.get(\"S18\") +"));
     ...
     client.print(F("\"&T6=\" + formData.get(\"S26\") +"));
     client.print(F("\"&T7=\" + formData.get(\"S27\") +"));
     client.print(F("\"&T8=\" + formData.get(\"S28\");"));
